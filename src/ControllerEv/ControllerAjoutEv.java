...
public class ControllerAjoutEv implements SousInterface, AjoutInterface {
    ...
    public void initialize(){
        ...
        lbtit.setText("Chef proj : Ajout un ev");
    ...
    public void addBut(){
        try {
            int id = ControllerAjoutEmp.callId("idev","event");
            ...
            if(titre == null) lbl.setText("titre est null");
                ...
                try {
                    ...
                    PreparedStatement statement = connection.prepareStatement("insert into event values(" + id + ",'" + titre + "','" + obj + "',to_date('" + dated + "','yyyy-mm-dd'),to_date('" + datef + "','yyyy-mm-dd'),'" + etat + "','" + loc + "' , to_date('" + LocalDate.now() + "','yyyy-mm-dd'))");
