...
public class ControllerModifEv implements ModifInterface, SousInterface {
    ...
    public void initialize(){
        lbtit.setText("Chef proj : Modification d'un ev");
    ...
    public void rechBut(){
        ...
        try {
            ...
            try {
                ...
                statement = connection.prepareStatement("SELECT * FROM event where idev = " + selectedId);
        ...
        try {
            ...
            if(titre == null) lbl.setText("titre est null");
                ...
                try {
                    ...
                    PreparedStatement statement = connection.prepareStatement("update event set titre = '" + titre + "' , obj = '" + obj + "' , deb = to_date('" + dated + "','yyyy-mm-dd')  , fin = to_date('" + datef + "','yyyy-mm-dd') , etat = '" + etat + "' , loc = '" + loc + "' where idev = " + id);
