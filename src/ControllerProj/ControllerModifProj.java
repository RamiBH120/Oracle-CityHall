...
public class ControllerModifProj implements SousInterface, ModifInterface {
    ...
    public void rechBut(){
        ...
        try {
            ...
            try {
                ...
                statement = connection.prepareStatement("SELECT * FROM project where idproj = " + selectedId);
        ...
        try {
            ...
            if(titre == null) lbl.setText("titre est null");
                ...
                try {
                    ...
                    PreparedStatement statement = connection.prepareStatement("update project set titre = '" + titre + "' , obj = '" + obj + "' , deb = to_date('" + dated + "','yyyy-mm-dd')  , fin = to_date('" + datef + "','yyyy-mm-dd') , etat = '" + etat + "' , loc = '" + loc + "' where idproj = " + id);
