...
public class ControllerAjoutIntrv implements SousInterface, AjoutInterface {
        ...
        public void initialize(){
            ...
            lbtit.setText("President : Ajout une intervention");
        ...
        public void addBut(){
            try {
                int id = ControllerAjoutEmp.callId("idinterv","interv");
                ...
                if(titre == null) lbl.setText("titre est null");
                    ...
                    try {
                        ...
                        PreparedStatement statement = connection.prepareStatement("insert into interv values(" + id + ",'" + titre + "','" + obj + "',to_date('" + dated + "','yyyy-mm-dd'),to_date('" + datef + "','yyyy-mm-dd'),'" + etat + "','" + loc + "' , to_date('" + LocalDate.now() + "','yyyy-mm-dd'))");
